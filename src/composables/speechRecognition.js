...
//TODO: test if https improve things
//TODO: test if Speech Recognition requires an Internet connection, so will not function when your PWA users are offline
// TODO: persevere the fact that the user has already granted permission to use the microphone so that we don't ask again when kill/restart the app
// TODO: persevere the fact that speech recognition is not available in user's setup so that we don't show the button back when kill/restart the app
import { ref } from "vue";
