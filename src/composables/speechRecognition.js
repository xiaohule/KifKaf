...
export const useSpeechRecognition = async (
  ...
  if (process.env.MODE !== "capacitor") {
    ...
    if (recognitionInstanceNaming) {
      ...
      webRecognitionInstance.lang = "fr-FR"; //TODO:4 make this dynamic based on user's language
